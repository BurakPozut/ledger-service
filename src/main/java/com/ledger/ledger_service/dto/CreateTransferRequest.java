...
public class CreateTransferRequest {
  ...
  public CreateTransferRequest(UUID sourceAccountId, UUID targetAccountId, BigDecimal amount, String currency, String clientRequestId){
  ...
  public void setTargerAccoutnId(UUID targetAccountId){ this.targetAccountId = targetAccountId; }
